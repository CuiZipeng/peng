...
# 移动该文件夹到另一个文件夹
shutil.move(
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory33\\SubDirectory333\\SubDirectory3333\\SubDirectory33333',
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory11\\SubDirectory111\\SubDirectory1111\\SubDirectory11111')

# 2.1 Create binary file
# 以二进制形式打开文件夹
fp1 = open(
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory11\\SubDirectory111\\SubDirectory1111\\SubDirectory11111\\BinaryFile1',
    'wb')
# 关闭这个工作流
fp1.close()
# 以二进制形式打开文件夹
fp2 = open(
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory22\\SubDirectory222\\SubDirectory2222\\SubDirectory22222\\BinaryFile2',
    'wb')
# 关闭这个工作流
fp2.close()
# 以二进制形式打开文件夹
fp3 = open(
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory33\\SubDirectory333\\SubDirectory3333\\SubDirectory33333\\BinaryFile3',
    'wb')
# 关闭这个工作流
fp3.close()
...
# 删除文件夹
os.remove(
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory22\\SubDirectory222\\SubDirectory2222\\SubDirectory22222\\BinaryFile1')

# 2.3 Move binary file
# 批量删除文件夹
shutil.move(
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory22\\SubDirectory222\\SubDirectory2222\\SubDirectory22222',
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory33\\SubDirectory333\\SubDirectory3333\\SubDirectory33333')
...
fp4 = open(
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory11\\SubDirectory111\\SubDirectory1111\\SubDirectory11111\\LogTextFile4.txt',
    'w+')
fp4.close()
# 对文件进行可读写两种操作（会首先自动清空文件内容）
fp5 = open(
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory22\\SubDirectory222\\SubDirectory2222\\SubDirectory22222\\LogTextFile5.txt',
    'w+')
fp5.close()
# 对文件进行 w+（可读写两种操作（会首先自动清空文件内容））
fp6 = open(
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory33\\SubDirectory333\\SubDirectory3333\\SubDirectory33333\\LogTextFile6.txt',
    'w+')
fp6.close()
...
fp7 = open(
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory33\\SubDirectory333\\SubDirectory3333\\SubDirectory33333\\LogTextFile7.txt',
    'w+', encoding='utf-8')
...
class Buffer:
    ...
    def _init_(self, name, max_q_length=100, max_data_size=1000, memory_limit=10000, fs=None, persist_method=None,
...
fp7 = open(
    'D:\\Users\\jason\\PycharmProjects\\Assignment1\\NewDirectory33\\SubDirectory333\\SubDirectory3333\\SubDirectory33333\\test.txt',
    'a+', encoding='utf-8')
...
file:
(0, '1624504262064473')
f6b903077fadd6f7f7924a2dcfd0d828_1624504262064473
pushed
(1, '1624504262064831')
35
a5b1d85b7654229dfe85526c3f385f_1624504262064831
pushed
(2, '1624504262064949')
007
d8c6c24a357e859f4873cf1e8a84a_1624504262064949
pushed
(3, '1624504262065086')
3
ca08f64e96a37c21811c2fb4ae7c73a_1624504262065086
pushed
(4, '1624504262065194')
27
a65fb6788dea8e8da166ed3b560c05_1624504262065194
pushed
(5, '1624504262065303')
a61bcbc2b566dff6ee056c589630a527_1624504262065303
pushed
(6, '1624504262065413')
815
a1feaf05f95d7565e1f45cd96c9c2_1624504262065413
pushed
(7, '1624504262065521')
e3bd9338ca1241c58489e3bbe2ea6581_1624504262065521
pushed
(8, '1624504262065630')
4
f04ad77210a18f9aed36e508cc8fc6c_1624504262065630
pushed
(9, '1624504262065739')
041
97
ec22aa365eb5fa99ecb1212f0e9_1624504262065739
pushed
